...
slideshow_config.read(os.path.join(slideshow_path,'xbmcubuntu/slideshow.conf'))
...
if __name__ == "__main__":
    ...
    ui.webView.load(QUrl(os.path.join(slideshow_path, "xbmcubuntu", "slides", "index.html")))
