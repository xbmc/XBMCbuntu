...
kodiuser=$1
homedir=/home/$kodiuser
[ -z $kodiuser ] && homedir=$HOME
GUISETTINGS=$homedir/.kodi/userdata/guisettings.xml
...
function check_device {
  ...
  then
    ...
    echo "Please configure a real alsa device in KODI -> System -> Settings -> System -> Audio Output"
    exit 1
  fi
}
...
EOF
  ...
  [ "$(id -u)" = "0" ] && chown $kodiuser:$kodiuser $homedir/.asoundrc
}
